...
namespace ParkEase.Test.UnitTest
{
    public class UserMapPageTest
    {
        ...
        [Fact]
        public async void WalkNavigationSavedSpotTest()
        {
            // Arrange
            var latitude = 51.074223986352735;
            var longitude = -114.09974241563248;
            ...
            // Act
            viewModel.WalkNavigationCommand.Execute(null);

            await Task.Delay(3000);

            // Assert
            dialogService.Verify(d => d.ShowAlertAsync("No saved location", "Please save a parking location first.", "OK"), Times.Once);
        }
        ...
        public async Task ShowPublicParkingTest()
        {
            ...
            viewModel.ShowAvailableParking = false;
